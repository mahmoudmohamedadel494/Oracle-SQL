...
begin 
    ...
    select CONTRATCT_ID ,  CONTACT_STARTDATE , CONTRACT_ENDDATE , PAYMENT_INSTALLMENTS_NO ,
     CONTRACT_TOTAL_FEES , CONTRACT_PAYMENT_TYPE  , nvl(CONTRACT_DEPOSIT_FEES , 0)
        into v_CONTRATCT_ID ,   v_CONTACT_STARTDATE , v_CONTRACT_ENDDATE , v_PAYMENT_INSTALLMENTS_NO , v_CONTRACT_TOTAL_FEES , v_CONTRACT_PAYMENT_TYPE , v_CONTRACT_DEPOSIT_FEES
    from contracts where CONTRATCT_ID = 105 ; 
